...
import servicePlans from "/images/service-building-plans.jpg";
import serviceEstimation from "/images/service-estimation.jpg";
...
import serviceSupervision from "/images/service-supervision.jpg";
import frontBuilding from "/images/front-building.jpg";
import serviceVendor from "@/assets/service-vendor.jpg";
import serviceLabour from "/images/service-labour.jpg";
import {
  Award,
  TrendingUp,
  Clock
    ...
    <div className="h-screen bg-background overflow-hidden">
      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        ...
        <a 
          ...
          className="absolute top-24 right-3 z-20 flex items-center gap-1.5 px-3 py-1.5 bg-accent text-accent-foreground rounded-full font-bold shadow-lg hover:scale-105 transition-transform text-sm"
        >
        ...
        <div className="relative z-10 w-full h-full flex items-center px-4 py-6">
          <div className="w-full max-w-md">
            {/* Logo & Tagline */}
            <div className="mt - 8 absolute top-6 left-1/2 -translate-x-1/2 text-center z-20">
              <h1 className="text-3xl font-extrabold text-white drop-shadow-lg whitespace-nowrap">
                SNR INFRA BUILDTECH
              </h1>
              <p className="text-white/100 text- bold whitespace-nowrap">
                Built on Trust, Rooted in Quality
              </p>
            </div>
            {/* Main Headline */}
            <div className="mt-20">
              <h2 className="text-base font-bold text-white leading mb-3">
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2 text-white/90 text-xs">
                <div className="flex items-center gap-2">
                  <Award className="w-10 h-10 text-accent flex-shrink-0 p-1.5 bg-white/20 rounded-full" />
                  <p className="text-white font-medium text-xs leading-tight">Professional Expertise</p>
                </div>
                <div className="flex items-center gap-2">
                  <TrendingUp className="w-10 h-10 text-accent flex-shrink-0 p-1.5 bg-white/20 rounded-full" />
                  <p className="text-white font-medium text-xs leading-tight">Transparent Reporting</p>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-10 h-10 text-accent flex-shrink-0 p-1.5 bg-white/20 rounded-full" />
